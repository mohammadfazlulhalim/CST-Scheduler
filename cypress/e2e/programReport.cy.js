...
describe('Test Program Report Page', () => {
  it('testNavigationToTheReportInstructorPage', ()=> {
    ...
    cy.get('.table-bordered tbody tr:nth-child(1) td:nth-child(2)').should('contain', 'CST');
